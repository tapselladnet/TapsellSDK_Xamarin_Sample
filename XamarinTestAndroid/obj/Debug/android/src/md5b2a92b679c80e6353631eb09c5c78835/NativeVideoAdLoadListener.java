...
public class NativeVideoAdLoadListener
		...
		ir.tapsell.xamarin.NativeVideoAdLoadListener
{
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("IR.Tapsell.Xamarin.NativeVideoAdLoadListener, TapsellXamarinSdk, Version=1.0.0.0, Culture=neutral, PublicKeyToken=null", NativeVideoAdLoadListener.class, __md_methods);
	}


	public NativeVideoAdLoadListener () throws java.lang.Throwable
	{
		super ();
		if (getClass () == NativeVideoAdLoadListener.class)
			mono.android.TypeManager.Activate ("IR.Tapsell.Xamarin.NativeVideoAdLoadListener, TapsellXamarinSdk, Version=1.0.0.0, Culture=neutral, PublicKeyToken=null", "", this, new java.lang.Object[] {  });
	}
