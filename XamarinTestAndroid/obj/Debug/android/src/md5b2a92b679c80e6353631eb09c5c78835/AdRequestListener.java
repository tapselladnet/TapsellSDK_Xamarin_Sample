...
public class AdRequestListener
		...
		ir.tapsell.xamarin.AdRequestListener
{
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("IR.Tapsell.Xamarin.AdRequestListener, TapsellXamarinSdk, Version=1.0.0.0, Culture=neutral, PublicKeyToken=null", AdRequestListener.class, __md_methods);
	}


	public AdRequestListener () throws java.lang.Throwable
	{
		super ();
		if (getClass () == AdRequestListener.class)
			mono.android.TypeManager.Activate ("IR.Tapsell.Xamarin.AdRequestListener, TapsellXamarinSdk, Version=1.0.0.0, Culture=neutral, PublicKeyToken=null", "", this, new java.lang.Object[] {  });
	}
