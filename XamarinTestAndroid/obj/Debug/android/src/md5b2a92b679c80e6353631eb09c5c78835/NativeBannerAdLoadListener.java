...
public class NativeBannerAdLoadListener
		...
		ir.tapsell.xamarin.NativeBannerAdLoadListener
{
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("IR.Tapsell.Xamarin.NativeBannerAdLoadListener, TapsellXamarinSdk, Version=1.0.0.0, Culture=neutral, PublicKeyToken=null", NativeBannerAdLoadListener.class, __md_methods);
	}


	public NativeBannerAdLoadListener () throws java.lang.Throwable
	{
		super ();
		if (getClass () == NativeBannerAdLoadListener.class)
			mono.android.TypeManager.Activate ("IR.Tapsell.Xamarin.NativeBannerAdLoadListener, TapsellXamarinSdk, Version=1.0.0.0, Culture=neutral, PublicKeyToken=null", "", this, new java.lang.Object[] {  });
	}
